...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width:690px;height:auto;margin:0 auto;">
        <asp:DataList ID="dlAra" runat="server" Width="690px">
            <ItemTemplate>
                <div style="width:690px; margin:0 auto;height:auto;">
                    ...
                    <div style="width:690px;height:20px;line-height:20px;font-size:12px; float:left; background-image: url('Temalar/makalegri.png'); background-repeat: inherit;">
                        ...
                        <div style="width:auto;height:20px;float:left;margin-right:15px;">
                            <img alt="" width="12" height="12" class="auto-style5" src="Temalar/goz.png" />&nbsp;<asp:Label ID="Label3" runat="server" Text='<%# Eval("MakaleOkunmaSayisi") %>' ForeColor="#666666"></asp:Label>
                        </div>
                        <div style="width:auto;height:20px;float:left;margin-right:15px;">
                            &nbsp;<img alt="" width="12" height="12" class="auto-style7" src="Temalar/yorum.png" /><asp:Label ID="Label4" runat="server" Text='<%# Eval("MakaleYorumSayisi") %>' ForeColor="#666666"></asp:Label>
                        </div>
                    </div>
