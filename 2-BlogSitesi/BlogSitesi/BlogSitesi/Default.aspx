<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="BlogSitesi.Default" %>
                ...
                <div style="width:690px; margin:0 auto;height:auto;">
                    ...
                    <div style="width:690px;height:20px;line-height:20px;font-size:12px; float:left; background-image: url('Temalar/makalegri.png'); background-repeat: inherit;">
                        <div style="width:auto;height:20px;float:left;margin-right:15px;">
                            &nbsp;<img alt="" class="auto-style5" src="Temalar/saat.png" /><asp:Label ID="Label2" runat="server" Text='<%# Eval("MakaleTarih","{0:dd MMMM yyyy}") %>' ForeColor="#666666"></asp:Label>
                        </div>
                        <div style="width:auto;height:20px;float:left;margin-right:15px;">
                            &nbsp;<img alt="" class="auto-style5" src="Temalar/goz.png" /><asp:Label ID="Label3" runat="server" Text='<%# Eval("MakaleOkunmaSayisi") %>' ForeColor="#666666"></asp:Label>
                        </div>
                        <div style="width:auto;height:20px;float:left;margin-right:15px;">
                            &nbsp;<img alt="" class="auto-style6" src="Temalar/yorum.png" /><asp:Label ID="Label4" runat="server" Text='<%# Eval("MakaleYorumSayisi") %>' ForeColor="#666666"></asp:Label>
                        </div>
                    </div>
